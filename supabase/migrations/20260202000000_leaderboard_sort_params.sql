-- Organizer leaderboard: add sort parameters.
-- get_organizer_leaderboard_for_riding(p_riding, p_sort_by, p_sort_order):
--   p_sort_by: 'name' | 'count' | 'surveys_started' | 'surveys_completed' (default 'count')
--   p_sort_order: 'asc' | 'desc' (default 'desc')


-- Drop old 1-arg overload so we can replace with 3-arg version.
DROP FUNCTION IF EXISTS "public"."get_organizer_leaderboard_for_riding"("p_riding" "text");
