-- Civic + unit sort keys for contact addresses; composite street sort in load_contact_list_page_ids.
-- Keep extraction aligned with crm/app/lib/contacts/street-number-parity-quick-filter.ts and street-address-sort.ts.
