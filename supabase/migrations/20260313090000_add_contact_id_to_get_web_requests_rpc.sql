-- Ensure get_web_requests returns contact_id (and referer) on 12-arg signature.
-- Keeps filter_has_message overload as canonical for PostgREST.

-- Drop legacy overloads to avoid ambiguity or stale return signatures.
...
-- Keep legacy 10-arg overload delegating to 12-arg implementation.
CREATE OR REPLACE FUNCTION public.get_web_requests(
  filter_success boolean DEFAULT NULL,
  filter_status text DEFAULT NULL,
  filter_category text DEFAULT NULL,
