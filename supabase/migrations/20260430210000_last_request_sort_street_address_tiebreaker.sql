-- Tie-break last_request with street_address only so DBs without street_civic_sort_int /
-- street_name_sort_key (migration 20260401120000 / 20260323193000) still work.
-- Prefer running full migrations for composite street sort on the Street column.
