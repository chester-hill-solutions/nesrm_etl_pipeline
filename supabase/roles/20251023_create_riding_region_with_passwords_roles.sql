...
CREATE ROLE riding_ajax_writer LOGIN PASSWORD '%M4owmneiJcb=8QaKi^2' INHERIT;
...
CREATE ROLE riding_algomamanitoulin_writer LOGIN PASSWORD '3N%GS^-Pyjo$Mf-8kS#0' INHERIT;
...
CREATE ROLE riding_auroraoakridgesrichmondhill_writer LOGIN PASSWORD 'rTQAIN))a#aC(MHOGKDF' INHERIT;
...
CREATE ROLE riding_barrieinnisfil_writer LOGIN PASSWORD 'W3VNIpgXz3k=XHMRJaRg' INHERIT;
...
CREATE ROLE riding_barriespringwateroromedonte_writer LOGIN PASSWORD '*8PSP5$eKX(zdG@YVI!L' INHERIT;
...
CREATE ROLE riding_bayofquinte_writer LOGIN PASSWORD 'T_1YIp9VDHcLIu_b0^ej' INHERIT;
...
CREATE ROLE riding_beacheseastyork_writer LOGIN PASSWORD 'fvOLPFa7LU+w0svvH=IY' INHERIT;
...
CREATE ROLE riding_bramptoncentre_writer LOGIN PASSWORD 'K2ORC)97_^Xiu6ax%c_4' INHERIT;
...
CREATE ROLE riding_bramptoneast_writer LOGIN PASSWORD '6$GtMZfMjOMhOQJI(_av' INHERIT;
...
CREATE ROLE riding_bramptonnorth_writer LOGIN PASSWORD '^6Kq!+G5d5=cowMK%yO(' INHERIT;
...
CREATE ROLE riding_bramptonsouth_writer LOGIN PASSWORD 'C!sd1l*G+aOZPoPOoCh&' INHERIT;
...
CREATE ROLE riding_bramptonwest_writer LOGIN PASSWORD 'GdeONaPDtbq_OIErdJDN' INHERIT;
...
CREATE ROLE riding_brantfordbrant_writer LOGIN PASSWORD 'W0uQOVXLN(MtqLFCZVUP' INHERIT;
...
CREATE ROLE riding_brucegreyowensound_writer LOGIN PASSWORD 'BiMaORZHDbDdBm%e=4fA' INHERIT;
...
CREATE ROLE riding_burlington_writer LOGIN PASSWORD 'JqIV6!xWj_RePVX6iNn$' INHERIT;
...
CREATE ROLE riding_cambridge_writer LOGIN PASSWORD 'JC)S^8FAqUu+KFiaak_W' INHERIT;
...
CREATE ROLE riding_carleton_writer LOGIN PASSWORD 'qj$QD!NE+2QXh%g1KJab' INHERIT;
...
CREATE ROLE riding_chathamkentleamington_writer LOGIN PASSWORD 'kK5fG0M)6$lCSO7XKDiO' INHERIT;
...
CREATE ROLE riding_davenport_writer LOGIN PASSWORD 'o8rqQa#Mgz!KpMXsLb4X' INHERIT;
...
CREATE ROLE riding_donvalleyeast_writer LOGIN PASSWORD 'RODgSanxM8GoNGP4pAUg' INHERIT;
...
CREATE ROLE riding_donvalleynorth_writer LOGIN PASSWORD 'otvIwN3pc%OSX-w2GbnE' INHERIT;
...
CREATE ROLE riding_donvalleywest_writer LOGIN PASSWORD 'pUZR@sEBHB-AuTnAttZP' INHERIT;
...
CREATE ROLE riding_dufferincaledon_writer LOGIN PASSWORD 'z9aypo2UHNuNGV-CgW1#' INHERIT;
...
CREATE ROLE riding_durham_writer LOGIN PASSWORD 'VZd9-d_Z9I1rnQe3#0pq' INHERIT;
...
CREATE ROLE riding_eglintonlawrence_writer LOGIN PASSWORD 'R$Q!W5PEapAose0=yG1=' INHERIT;
...
CREATE ROLE riding_elginmiddlesexlondon_writer LOGIN PASSWORD 'BhcI1rs94ozJBXFJ=VKH' INHERIT;
...
CREATE ROLE riding_essex_writer LOGIN PASSWORD '-#%ZPa(%TI8!g_CKw7az' INHERIT;
...
CREATE ROLE riding_etobicokecentre_writer LOGIN PASSWORD 'IWV&R)ZWVwbqIQr363BR' INHERIT;
...
CREATE ROLE riding_etobicokenorth_writer LOGIN PASSWORD 'Kp&nVSR)ZL#OCN4a8Mb9' INHERIT;
...
CREATE ROLE riding_etobicokelakeshore_writer LOGIN PASSWORD '%^WjBIH3QpSOxOX%eD9i' INHERIT;
...
CREATE ROLE riding_flamboroughglanbrook_writer LOGIN PASSWORD 'ALfip@GJJ-9thOySOoFa' INHERIT;
...
CREATE ROLE riding_glengarryprescottrussell_writer LOGIN PASSWORD 'LtEpiZVE65dKDr65C1(o' INHERIT;
...
CREATE ROLE riding_guelph_writer LOGIN PASSWORD '!U7Di^PVm$19jlINuAgK' INHERIT;
...
CREATE ROLE riding_haldimandnorfolk_writer LOGIN PASSWORD '#U*&ktGG)LIHh05AQSP#' INHERIT;
...
CREATE ROLE riding_haliburtonkawarthalakesbrock_writer LOGIN PASSWORD 'xW$L3!azZ%h9niO$YO%=' INHERIT;
...
CREATE ROLE riding_hamiltoncentre_writer LOGIN PASSWORD 'pTV)6ZkWeBDCVvF*GzZb' INHERIT;
...
CREATE ROLE riding_hamiltoneaststoneycreek_writer LOGIN PASSWORD 'sD*q&c-Bf^BnNb+FrTT_' INHERIT;
...
CREATE ROLE riding_hamiltonmountain_writer LOGIN PASSWORD '3yxGTW(Aod6muCzCQZBz' INHERIT;
...
CREATE ROLE riding_hamiltonwestancasterdundas_writer LOGIN PASSWORD 'GgDa17LbQ!PMov#MPtJ1' INHERIT;
...
CREATE ROLE riding_hastingslennoxandaddington_writer LOGIN PASSWORD 'd6)u1nEZL=sheO__G%F*' INHERIT;
...
CREATE ROLE riding_humberriverblackcreek_writer LOGIN PASSWORD '_e-TN^4iVNX7ORFz8=Mx' INHERIT;
...
CREATE ROLE riding_huronbruce_writer LOGIN PASSWORD '1=ZwM!je=dXt9XKGLkgq' INHERIT;
...
CREATE ROLE riding_kanatacarleton_writer LOGIN PASSWORD 'sIHV8qrJMGOged_UCXq8' INHERIT;
...
CREATE ROLE riding_kenorarainyriver_writer LOGIN PASSWORD 'NrO@(KlIRhpDdWrX#b6a' INHERIT;
...
CREATE ROLE riding_kiiwetinoong_writer LOGIN PASSWORD 'i(-3g3mHqfXM9HOop%oP' INHERIT;
...
CREATE ROLE riding_kingstonandtheislands_writer LOGIN PASSWORD 'v7aoN5Dq0e%Zq-0@pXV8' INHERIT;
...
CREATE ROLE riding_kingvaughan_writer LOGIN PASSWORD 'Obej-tBA)R9%FzG@kFOe' INHERIT;
...
CREATE ROLE riding_kitchenercentre_writer LOGIN PASSWORD 'JVJv5WG3Xav3V(ymNgmm' INHERIT;
...
CREATE ROLE riding_kitchenersouthhespeler_writer LOGIN PASSWORD 'aSgYZBzEMuPx@Oem*%yV' INHERIT;
...
CREATE ROLE riding_kitchenerconestoga_writer LOGIN PASSWORD 'vyMcM-#YIjoy_V3#weAV' INHERIT;
...
CREATE ROLE riding_lambtonkentmiddlesex_writer LOGIN PASSWORD 'T8sdSZve9lhwT-CN)Ng+' INHERIT;
...
CREATE ROLE riding_lanarkfrontenackingston_writer LOGIN PASSWORD '2K2!LBtayZPRPDtiUT@R' INHERIT;
...
CREATE ROLE riding_leedsgrenvillethousandislandsandrideaulakes_writer LOGIN PASSWORD 'ZTx+&IiJBE9P*$fk0%iQ' INHERIT;
...
CREATE ROLE riding_londonnorthcentre_writer LOGIN PASSWORD '&ADa05*DAVBKcMJ9F_nq' INHERIT;
...
CREATE ROLE riding_londonwest_writer LOGIN PASSWORD ')E+L5P%8HrJ@Sa0LyjuR' INHERIT;
...
CREATE ROLE riding_londonfanshawe_writer LOGIN PASSWORD 'OB52nl*KI5+vc9y-nBdK' INHERIT;
...
CREATE ROLE riding_markhamstouffville_writer LOGIN PASSWORD '0d+4TPJkEuc^mJ%Ux%&X' INHERIT;
...
CREATE ROLE riding_markhamthornhill_writer LOGIN PASSWORD '#UF7Fzyn48QS^4cQJQl_' INHERIT;
...
CREATE ROLE riding_markhamunionville_writer LOGIN PASSWORD '4Py#1MGYSB+a!h=9h6pY' INHERIT;
...
CREATE ROLE riding_milton_writer LOGIN PASSWORD 'F)KX%C6s$y94z6mzNWaD' INHERIT;
...
CREATE ROLE riding_mississaugacentre_writer LOGIN PASSWORD 'OqSfB9!4$$-QpPZzrOmI' INHERIT;
...
CREATE ROLE riding_mississaugaeastcooksville_writer LOGIN PASSWORD 'V@L-Djm#aLdPmXbvys-O' INHERIT;
...
CREATE ROLE riding_mississaugaerinmills_writer LOGIN PASSWORD 'G%6QzXQGFE5BUnKeyEkH' INHERIT;
...
CREATE ROLE riding_mississaugalakeshore_writer LOGIN PASSWORD 'eRH#v7aLFxT*CN9TXZDj' INHERIT;
...
CREATE ROLE riding_mississaugamalton_writer LOGIN PASSWORD 'MHCzz8kf-i^FuSX=L&GM' INHERIT;
...
CREATE ROLE riding_mississaugastreetsville_writer LOGIN PASSWORD '9+%Env5Q4D2AJjXTGx$=' INHERIT;
...
CREATE ROLE riding_mushkegowukjamesbay_writer LOGIN PASSWORD 'ZGavT%kmu&+hVZCPFImN' INHERIT;
...
CREATE ROLE riding_nepean_writer LOGIN PASSWORD 'V(5M!Q#n1uq2D#1PQ(GP' INHERIT;
...
CREATE ROLE riding_newmarketaurora_writer LOGIN PASSWORD 'YG2nrit*w1%t^%NKsBut' INHERIT;
...
CREATE ROLE riding_niagaracentre_writer LOGIN PASSWORD 'Ncqt2EFK6)#MA8_Gq9e1' INHERIT;
...
CREATE ROLE riding_niagarafalls_writer LOGIN PASSWORD 'usqLam+0xh2Vc_ZiNs9%' INHERIT;
...
CREATE ROLE riding_niagarawest_writer LOGIN PASSWORD 'NOu(9U2QsR-$SPZECW_s' INHERIT;
...
CREATE ROLE riding_nickelbelt_writer LOGIN PASSWORD 'JIS+bV%W8(oTEU3*rz7M' INHERIT;
...
CREATE ROLE riding_nipissing_writer LOGIN PASSWORD '!*JvGXz)5GbZo1()JYWE' INHERIT;
...
CREATE ROLE riding_northumberlandpeterboroughsouth_writer LOGIN PASSWORD '@YTKJVlkL2_zS=D#*VjX' INHERIT;
...
CREATE ROLE riding_oakville_writer LOGIN PASSWORD 'ge-L1HKy%I8!H^PoAxD)' INHERIT;
...
CREATE ROLE riding_oakvillenorthburlington_writer LOGIN PASSWORD 'fW%!X#FJAfPDAUven&vj' INHERIT;
...
CREATE ROLE riding_orlans_writer LOGIN PASSWORD 'BAdIIcWunanvKDNL1ybe' INHERIT;
...
CREATE ROLE riding_oshawa_writer LOGIN PASSWORD 'Dt1wYPYilPGhr4LpX2T9' INHERIT;
...
CREATE ROLE riding_ottawacentre_writer LOGIN PASSWORD 'eE#AuDFxF5QvTJX5BI7(' INHERIT;
...
CREATE ROLE riding_ottawasouth_writer LOGIN PASSWORD 'ZT)IIPBT2*mlI1Yjx2Vv' INHERIT;
...
CREATE ROLE riding_ottawawestnepean_writer LOGIN PASSWORD 'PC)GMXNWHs%@qSQb1$0Z' INHERIT;
...
CREATE ROLE riding_ottawavanier_writer LOGIN PASSWORD '*_e*xy*s_VASTj*tHSvb' INHERIT;
...
CREATE ROLE riding_oxford_writer LOGIN PASSWORD 'W=)4tOU)NXZ#mmE=@Hxe' INHERIT;
...
CREATE ROLE riding_parkdalehighpark_writer LOGIN PASSWORD 'TNAFv6AK9pXu4U9iCYEA' INHERIT;
...
CREATE ROLE riding_parrysoundmuskoka_writer LOGIN PASSWORD 'Edr_4Evcvlla%T*wUba0' INHERIT;
...
CREATE ROLE riding_perthwellington_writer LOGIN PASSWORD 'jTo^L(3f1w7G5*KUUNtI' INHERIT;
...
CREATE ROLE riding_peterboroughkawartha_writer LOGIN PASSWORD 'gb+NzsNQas^5iRCZaa^x' INHERIT;
...
CREATE ROLE riding_pickeringuxbridge_writer LOGIN PASSWORD 'rkC7Be)2S)67I50otW2v' INHERIT;
...
CREATE ROLE riding_renfrewnipissingpembroke_writer LOGIN PASSWORD 'vAK+Ga%bScOCW!+0A#Am' INHERIT;
...
CREATE ROLE riding_richmondhill_writer LOGIN PASSWORD 'O$hr@a#3YP%CiZ5kpoZJ' INHERIT;
...
CREATE ROLE riding_sarnialambton_writer LOGIN PASSWORD 'bjZ0E5g5=In$O1Ov#u91' INHERIT;
...
CREATE ROLE riding_saultstemarie_writer LOGIN PASSWORD 'vbJlXhxbGorIO+Jzwm2X' INHERIT;
...
CREATE ROLE riding_scarboroughcentre_writer LOGIN PASSWORD '2oGT(Tmb=yTd-NLG79x@' INHERIT;
...
CREATE ROLE riding_scarboroughnorth_writer LOGIN PASSWORD 'ktp)r71-bCbisuiNQPTZ' INHERIT;
...
CREATE ROLE riding_scarboroughsouthwest_writer LOGIN PASSWORD 'uL2a59yy_e-tPZCTE0js' INHERIT;
...
CREATE ROLE riding_scarboroughagincourt_writer LOGIN PASSWORD 'B)OASFIqeRJJBzA#zvSO' INHERIT;
...
CREATE ROLE riding_scarboroughguildwood_writer LOGIN PASSWORD 'b20EBab(GMqL7A6zekAg' INHERIT;
...
CREATE ROLE riding_scarboroughrougepark_writer LOGIN PASSWORD 'pN*nqW*Hj+dA)ozMC4eI' INHERIT;
...
CREATE ROLE riding_simcoenorth_writer LOGIN PASSWORD 'BacqaN^TDDu@PG!Q7!+d' INHERIT;
...
CREATE ROLE riding_simcoegrey_writer LOGIN PASSWORD '#PiVNg-GtfFS%b(x3H0g' INHERIT;
...
CREATE ROLE riding_spadinafortyork_writer LOGIN PASSWORD '%7bTcdRKEjbBos-)!s@C' INHERIT;
...
CREATE ROLE riding_stcatharines_writer LOGIN PASSWORD '(vdTv@G^tVCLN8Kicf_u' INHERIT;
...
CREATE ROLE riding_stormontdundassouthglengarry_writer LOGIN PASSWORD 'XEHNrAkNs%JH6ohmXKkE' INHERIT;
...
CREATE ROLE riding_sudbury_writer LOGIN PASSWORD '3iqF59Fn@$Ls1&=(6A0l' INHERIT;
...
CREATE ROLE riding_thornhill_writer LOGIN PASSWORD 'bGnlAI8V^#hl60fcKImw' INHERIT;
...
CREATE ROLE riding_thunderbayatikokan_writer LOGIN PASSWORD 'PuMK(rvupqO64j3RrdHv' INHERIT;
...
CREATE ROLE riding_thunderbaysuperiornorth_writer LOGIN PASSWORD 'p4uET&9^E8fgkWTay83D' INHERIT;
...
CREATE ROLE riding_timiskamingcochrane_writer LOGIN PASSWORD 'YiI5)Gjb=^3MRsQcA0#)' INHERIT;
...
CREATE ROLE riding_timmins_writer LOGIN PASSWORD 'PaCm6alqHQ8Z(pS&KYbS' INHERIT;
...
CREATE ROLE riding_torontocentre_writer LOGIN PASSWORD 'rz*ZiZQguysdQr7a5y)z' INHERIT;
...
CREATE ROLE riding_torontodanforth_writer LOGIN PASSWORD 'a8dvI60m8yS+Kfe7#TED' INHERIT;
...
CREATE ROLE riding_torontostpauls_writer LOGIN PASSWORD 'Z#Y)a2r+9S#^0A=sEube' INHERIT;
...
CREATE ROLE riding_universityrosedale_writer LOGIN PASSWORD 'GR_^U0t9VdTcxZGk@Zdb' INHERIT;
...
CREATE ROLE riding_vaughanwoodbridge_writer LOGIN PASSWORD 'mInrH$B6$1%8V8EOfTi)' INHERIT;
...
CREATE ROLE riding_waterloo_writer LOGIN PASSWORD '3dBZv(FJYVn-AGNAFVpb' INHERIT;
...
CREATE ROLE riding_wellingtonhaltonhills_writer LOGIN PASSWORD 'Z@$KLlJ8IWF57WA1lCzc' INHERIT;
...
CREATE ROLE riding_whitby_writer LOGIN PASSWORD 'T0*P@jISBWGFYzTMbZ($' INHERIT;
...
CREATE ROLE riding_willowdale_writer LOGIN PASSWORD 'w_!vu)eMp+IIJINXty2H' INHERIT;
...
CREATE ROLE riding_windsorwest_writer LOGIN PASSWORD 'RE0aq!SIw6Gy*95vULxY' INHERIT;
...
CREATE ROLE riding_windsortecumseh_writer LOGIN PASSWORD 'jHSXAkLh(iC%kS57R#ns' INHERIT;
...
CREATE ROLE riding_yorkcentre_writer LOGIN PASSWORD '2Agen#O5@mpBq@qqZ0^f' INHERIT;
...
CREATE ROLE riding_yorksouthweston_writer LOGIN PASSWORD 'Aloolg4$iT&HXFHZ5tTl' INHERIT;
...
CREATE ROLE riding_yorksimcoe_writer LOGIN PASSWORD '^TKbI@YbC^D=O11HCPDH' INHERIT;
...
CREATE ROLE region_centraleast_writer LOGIN PASSWORD 'Bq+1f2JD$uU8#MnSMubL' INHERIT;
...
CREATE ROLE region_centralnorth_writer LOGIN PASSWORD 'ozGD8Ms!$#Iv3ny&SF!H' INHERIT;
...
CREATE ROLE region_centralwest_writer LOGIN PASSWORD '%bIR^t9mgdeU-X8PafQb' INHERIT;
...
CREATE ROLE region_east_writer LOGIN PASSWORD 'LISaw0I!X_8IgyfdRd0E' INHERIT;
...
CREATE ROLE region_north_writer LOGIN PASSWORD 'RyU73&XROXBp*GIQYYBV' INHERIT;
...
CREATE ROLE region_southcentral_writer LOGIN PASSWORD '72KMiF7FM1UwTc!=lkh7' INHERIT;
...
CREATE ROLE region_southwest_writer LOGIN PASSWORD 'hWrN_dvWhIK0(@X&hRpo' INHERIT;
...
CREATE ROLE region_torontoede_writer LOGIN PASSWORD 'i5sCgT(Qrr3g-*7y!uyg' INHERIT;
...
CREATE ROLE region_torontoyns_writer LOGIN PASSWORD '8HaUuI-9F@W4cqV&)z&=' INHERIT;
