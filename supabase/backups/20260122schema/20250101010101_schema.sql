...
ALTER TABLE ONLY "public"."user_view_preferences"
    ADD CONSTRAINT "user_view_preferences_user_id_unique" UNIQUE ("user_id");
...
CREATE OR REPLACE TRIGGER "update_user_view_preferences_updated_at" BEFORE UPDATE ON "public"."user_view_preferences" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
ALTER TABLE ONLY "public"."user_view_preferences"
    ADD CONSTRAINT "user_view_preferences_current_view_id_fkey" FOREIGN KEY ("current_view_id") REFERENCES "public"."views"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."user_view_preferences"
    ADD CONSTRAINT "user_view_preferences_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
CREATE POLICY "allow admin read preferences" ON "public"."user_view_preferences" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = ANY (ARRAY['super_admin'::"public"."role_type", 'admin'::"public"."role_type"]))))));
...
CREATE POLICY "allow users manage own preferences" ON "public"."user_view_preferences" TO "authenticated" USING (("user_id" = "auth"."uid"())) WITH CHECK (("user_id" = "auth"."uid"()));
